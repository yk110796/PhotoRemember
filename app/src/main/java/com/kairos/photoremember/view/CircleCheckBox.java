...
//        pressedAnimator.start();
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            final TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.CircleCheckBox);
            color = a.getColor(R.styleable.CircleCheckBox_cb_color, color);
            pressedRingWidth = (int) a.getDimension(R.styleable.CircleCheckBox_cb_pressed_ring_width, pressedRingWidth);
            a.recycle();
        }
