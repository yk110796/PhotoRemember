...
import com.kairos.photoremember.asynctask.ClusteringForMapTask;
import com.kairos.photoremember.asynctask.ClusteringTask2;
                ...
                switch (motionEvent.getActionMasked()) {
                    ...
                    case MotionEvent.ACTION_UP:
                        if(pId <= 0 && imageNo > 0) {
                            ...
                            intent.putExtra("com.kairos.photrace.position", imageNo);
           ...
           /* if (imageView != null) {
                imageView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        Intent intent = new Intent(getActivity(), PhotoDetailActivity2.class);
                        intent.putExtra("com.kairos.photrace.position", imageNum);
                        intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TOP);
                        getActivity().startActivity(intent);
                    }
                });
